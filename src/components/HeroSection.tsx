...
const HeroSection: React.FC<HeroSectionProps> = ({ onOpenModal }) => {
    // Family images for "Helping families since '94"
    const familyImages = [
        'https://images.unsplash.com/photo-1511895426328-dc8714191300?auto=format&fit=crop&w=100&h=100&q=80',
        'https://images.unsplash.com/photo-1475503572774-15a45e5d60b9?auto=format&fit=crop&w=100&h=100&q=80',
        'https://images.unsplash.com/photo-1561525155-40a650192479?auto=format&fit=crop&w=100&h=100&q=80',
    ];
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-start">
                ...
                <div className="md:col-span-8 z-10">
                    ...
                    <h1 className="font-serif text-5xl md:text-6xl lg:text-7xl leading-[0.9] text-slate-900 mb-12">
                        I lost money <br />
                        <span className="font-hand text-4xl md:text-5xl lg:text-6xl text-slate-600">so you don&apos;t have to.</span>
                    </h1>
                ...
                {/* Right Column: Edwin's Photo (Enlarged) */}
                <div className="md:col-span-4 relative hidden md:block">
                    {/* Edwin's Photo - Large & Primary */}
                    <div className="absolute top-0 right-0 w-80 h-[420px] bg-slate-200 overflow-hidden border-2 border-slate-900 rotate-2 z-10 shadow-xl">
                        <img
                    ...
                    {/* The "Note" Card - Positioned Below */}
                    <div className="absolute top-[380px] -left-8 bg-white p-6 shadow-xl border border-slate-100 max-w-xs rotate-1 z-30">

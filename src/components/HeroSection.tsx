        ...
        <header className="relative pt-40 pb-20 md:pt-52 md:pb-32 px-6 max-w-7xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-12 gap-12 items-start">
                ...
                <div className="md:col-span-7 z-10">
                    ...
                    {/* Personal Note - Styled like the sticky note */}
                    <div className="max-w-lg bg-yellow-100 p-5 shadow-md rotate-[-1deg] border border-yellow-200/50 mb-10">
                        <p className="font-hand text-lg text-slate-800 leading-snug">
                ...
                {/* Right Column: Edwin's Photo (Extra Large) with Sticky Notes */}
